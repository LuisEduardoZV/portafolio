    ...
    <MainCard>
      ...
      <section className='flex justify-between gap-28 mt-32 sm:w-10/12 sm:items-center sm:mt-16 sm:gap-32 sm:flex-nowrap flex-col lg:flex-wrap lg:w-full lg:mt-5 lg:gap-20 transition-all duration-300 ease-in-out xl:flex-wrap'>
        <MainContentCard className='duration-300 ease-in-out flex-col gap-5 relative max-h-min lg:max-h-72 2xl:max-h-60 sm:w-11/12 sm:relative group/card sm:max-h-64 lg:flex-row lg:hover:shadow-main-card'>
          <div className='h-full lg:max-h-max rounded-lg group/image peer w-full max-w-[50%] sm:max-w-[83%] -mt-24 ml-28 sm:-mt-0 sm:ml-0 sm:absolute sm:max-h-44 sm:inset-0 sm:start-1/2 sm:-translate-x-1/2 sm:-top-20 sm:group-hover/card:-translate-y-10 sm:group-hover/card:translate-x-3 transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 lg:group-hover/card:translate-y-0 lg:group-hover/card:translate-x-0'>
            <div className='lg:scale-[1.2] 2xl:scale-[1] lg:group-hover/card:-translate-x-7 transition-all duration-300 ease-in-out lg:group-hover/card:shadow-[1px_3px_13px_3px_rgba(116,116,116,1)] rounded-lg p-0 relative flex w-full h-full sm:group-hover/image:scale-100 sm:xl:group-hover/image:translate-x-0 lg:-translate-x-5 lg:group-hover/image:scale-[2] lg:group-hover/image:translate-x-20 xl:group-hover/image:scale-[1.3] xl:group-hover/card:scale-[1.55] xl:group-hover/card:translate-x-8 2xl:group-hover/image:scale-[1.3] 2xl:group-hover/card:scale-[1.3] 2xl:group-hover/card:translate-x-16'>
              <div className='bg-loginDefault bg-origin-border bg-center bg-cover bg-no-repeat absolute aspect-video max-h-min lg:max-h-72 2xl:max-h-60 w-full h-full rounded-lg transition-all duration-300 ease-in-out group-hover/image:bg-mainBlack' />
              <div className='bg-mainDefault bg-origin-border bg-center bg-cover bg-no-repeat aspect-video max-h-min lg:max-h-72 2xl:max-h-60 w-full rounded-lg clip-bg-images-projects animate-formingImages transition-all duration-300 ease-in-out shadow group-hover/image:bg-loginBlack' />
            </div>
          </div>
          <div className='flex flex-col w-full sm:h-56 h-min justify-between lg:group-hover/card:ml-5 sm:peer-hover:ml-0 sm:pt-24 gap-3 sm:group-hover/card:pt-0 lg:pt-0 lg:group-hover/card:h-full transition-all duration-300 ease-in-out lg:h-max xl:group-hover/card:pl-28 xl:pl-5 2xl:pl-0 2xl:gap-5 2xl:group-hover/card:gap-3'>
        ...
        <MainContentCard className='duration-300 ease-in-out flex-col gap-5 relative lg:max-h-max 2xl:max-h-60 sm:w-11/12 sm:relative group/card sm:max-h-64 lg:flex-row-reverse lg:hover:shadow-main-card'>
          <div className='h-full lg:max-h-max w-full max-w-[50%] sm:max-w-[83%] -mt-24 -ml-28 sm:-mt-0 sm:-ml-0 rounded-lg group/image peer sm:w-2/3 sm:absolute sm:max-h-44 sm:inset-0 sm:start-1/2 sm:-translate-x-1/2 sm:-top-20 sm:group-hover/card:-translate-y-10 sm:group-hover/card:-translate-x-full transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 lg:group-hover/card:translate-y-0 lg:group-hover/card:translate-x-0'>
          ...
          <div className='flex flex-col w-full h-56 justify-between lg:group-hover/card:mr-5 transition-all duration-300 ease-in-out sm:peer-hover:ml-0 sm:pt-16 gap-3 sm:group-hover/card:pt-0 sm:items-end lg:pt-0 lg:group-hover/card:h-full lg:h-max lg:group-hover/card:py-3 xl:group-hover/card:pr-28 xl:pr-5 2xl:pr-0 2xl:gap-5 2xl:group-hover/card:gap-3'>
        ...
        <MainContentCard className='duration-300 ease-in-out flex-col gap-5 relative mb-20 sm:mb-0 lg:max-h-max sm:w-11/12 sm:relative group/card sm:max-h-64 lg:flex-row lg:hover:shadow-main-card'>
          <div className='h-full lg:max-h-max w-full max-w-[50%] sm:max-w-[83%] -mt-24 ml-28 sm:-mt-0 sm:ml-0 rounded-lg group/image peer sm:w-2/3 sm:absolute sm:max-h-44 sm:inset-0 sm:start-1/2 sm:-translate-x-1/2 sm:-top-20 sm:group-hover/card:-translate-y-10 sm:group-hover/card:translate-x-3 transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 lg:group-hover/card:translate-y-0 lg:group-hover/card:translate-x-0'>
          ...
          <div className='flex flex-col w-full justify-between lg:group-hover/card:ml-5 sm:peer-hover:ml-0 sm:pt-24 gap-3 sm:group-hover/card:pt-0 lg:pt-0 lg:group-hover/card:h-full transition-all duration-300 ease-in-out lg:h-max xl:group-hover/card:pl-28 xl:pl-5 2xl:pl-0 2xl:gap-5 2xl:group-hover/card:gap-3'>
            ...
            <div className='flex justify-between flex-row'>
              ...
              <div className='flex flex-wrap pl-3 sm:pl-0 gap-3 lg:gap-2'>
